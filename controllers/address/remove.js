...
const remove = async (req, res) => {
    const { error, value } = (0, validateRequest_1.validateRequest)(addressSchema_1.deleteAddressSchema, req.params);
    if (error) {
    ...
    try {
        ...
        logger_1.default.info('Address deleted successfully');
