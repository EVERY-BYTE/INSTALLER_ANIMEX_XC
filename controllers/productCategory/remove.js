...
const remove = async (req, res) => {
    const { error, value } = (0, validateRequest_1.validateRequest)(productCategorySchema_1.deleteProductCategorySchema, req.params);
    if (error) {
    ...
    try {
        ...
        logger_1.default.info('Product category deleted successfully');
